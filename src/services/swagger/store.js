...
export async function getOrderById(params, options) { // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
...
export async function deleteOrder(params, options) { // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  const { orderId: param0, ...queryParams } = params;
  return request(`/store/order/${param0}`, {
    method: 'DELETE',
    params: { ...queryParams },
